...
$sql_price_bangalore="SELECT * FROM `price_bangalore` WHERE `source` LIKE '$source' AND `dest` LIKE '$dest' AND `type` LIKE '$type'";
$result = $connect->query($sql_price_bangalore);
...
<br>
<center>
<td><form action="book_bangalore.php"><button style="background-color: black; padding: 28px 80px; type="submit"; align=center;"><span style=color:white;><h3>Go back</h3></span></a></td></button></form><br><br>
