...
$sql_price_chennai="SELECT * FROM `price_chennai` WHERE `source` LIKE '$source' AND `dest` LIKE '$dest' AND `type` LIKE '$type'";
$result = $connect->query($sql_price_chennai);
...
<br>
<center>
<td><form action="book_chennai.php"><button style="background-color: black; padding: 28px 80px; type="submit"; align=center;"><span style=color:white;><h3>Go back</h3></span></a></td></button></form><br><br>
